      ...
      {open && rect && createPortal(
        ...
        >
          <div className="flex items-center justify-between border-b border-ink-100 px-4 py-3 dark:border-ink-800">
            <div>
              <p className="text-sm font-semibold text-ink-900 dark:text-white">Solicitari</p>
              <p className="text-[11px] text-ink-400">
                {isAdmin ? 'Cereri de la sefii de santier' : 'Cererile tale si raspunsurile lor'}
              </p>
            </div>
            ...
            {loading && items.length === 0 ? (
              ...
              <div className="grid place-items-center gap-2 py-10 text-center">
                ...
                <p className="text-sm text-ink-500">
                  {isAdmin ? 'Nicio solicitare deocamdata' : 'Nu ai trimis nicio solicitare'}
                </p>
              </div>
            ) : (
